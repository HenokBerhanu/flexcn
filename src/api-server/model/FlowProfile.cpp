...
bool FlowProfile::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "FlowProfile" : pathPrefix;
...
bool FlowProfile::operator==(const FlowProfile& rhs) const {
  return
      ...
      ((!anAddrIsSet() && !rhs.anAddrIsSet()) ||
       (anAddrIsSet() && rhs.anAddrIsSet() &&
        getAnAddr() == rhs.getAnAddr())) &&
...
void to_json(nlohmann::json& j, const FlowProfile& o) {
  j = nlohmann::json();
  if (o.anAddrIsSet()) j["an_addr"] = o.m_An_addr;
  if (o.upfAddrIsSet()) j["upf_addr"] = o.m_Upf_addr;
