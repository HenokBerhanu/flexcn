...
bool Bearer::operator==(const Bearer& rhs) const {
  return
      ...
      ((!sliceIdIsSet() && !rhs.sliceIdIsSet()) ||
       (sliceIdIsSet() && rhs.sliceIdIsSet() &&
        getSliceId() == rhs.getSliceId())) &&

      ((!tosIsSet() && !rhs.tosIsSet()) ||
       (tosIsSet() && rhs.tosIsSet() && getTos() == rhs.getTos())) &&
...
void to_json(nlohmann::json& j, const Bearer& o) {
  ...
  if (o.sliceIdIsSet()) j["slice_id"] = o.m_Slice_id;
  if (o.tosIsSet()) j["tos"] = o.m_Tos;
  j["imsi"]       = o.m_Imsi;
