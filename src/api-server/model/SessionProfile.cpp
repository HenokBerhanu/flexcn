...
bool SessionProfile::is_all_setted() {
  return m_SupiIsSet & m_DnnIsSet & m_Amf_addrIsSet & m_Pdu_session_typeIsSet &
         m_PlmnIdIsSet & m_PduSeIdIsSet & m_AdIpv4AddrIsSet &
         m_UeIpv4AddrIsSet & m_SnssaiIsSet & m_FlowsIsSet;
}
...
bool SessionProfile::validate(
    std::stringstream& msg, const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "SessionProfile" : pathPrefix;
...
bool SessionProfile::operator==(const SessionProfile& rhs) const {
  return
      ...
      ((!amfAddrIsSet() && !rhs.amfAddrIsSet()) ||
       (amfAddrIsSet() && rhs.amfAddrIsSet() &&
        getAmfAddr() == rhs.getAmfAddr())) &&

      ((!pduSessionTypeIsSet() && !rhs.pduSessionTypeIsSet()) ||
       (pduSessionTypeIsSet() && rhs.pduSessionTypeIsSet() &&
        getPduSessionType() == rhs.getPduSessionType())) &&

      ((!plmnIdIsSet() && !rhs.plmnIdIsSet()) ||
       (plmnIdIsSet() &&
        rhs.plmnIdIsSet())) &&  //&& getPlmnId() == rhs.getPlmnId())) &&
      ...
      ((!snssaiIsSet() && !rhs.snssaiIsSet()) ||
       (snssaiIsSet() &&
        rhs.snssaiIsSet())) &&  // getSnssai() == rhs.getSnssai())) &&
...
void to_json(nlohmann::json& j, const SessionProfile& o) {
  ...
  if (o.amfAddrIsSet()) j["amf_addr"] = o.m_Amf_addr;
  if (o.pduSessionTypeIsSet()) j["pdu_session_type"] = o.m_Pdu_session_type;
