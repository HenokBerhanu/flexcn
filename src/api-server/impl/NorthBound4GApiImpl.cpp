...
NorthBound4GApiImpl::NorthBound4GApiImpl(const std::shared_ptr<Pistache::Rest::Router>& rtr, 
std::shared_ptr<App4G> flexcn_app_inst) : NorthBound4GApi(rtr), m_flexcn_app(flexcn_app_inst)
{
}

void NorthBound4GApiImpl::add_bearer(const Bearer &bearer, Pistache::Http::ResponseWriter &response) {
    nlohmann::json j;
...
void NorthBound4GApiImpl::delete_a_single_bearer_by_imsi_bearer(const std::string &imsiBearer, Pistache::Http::ResponseWriter &response) {
...
void NorthBound4GApiImpl::delete_a_single_bearer_by_id(const std::string &id, Pistache::Http::ResponseWriter &response) {
...
void NorthBound4GApiImpl::delete_all_bearers(Pistache::Http::ResponseWriter &response) {
...
void NorthBound4GApiImpl::get_stats_by_imsi_bearer(const std::string &imsiBearer, Pistache::Http::ResponseWriter &response) {
    std::vector<Bearer> stats = m_flexcn_app->get_stats_by_imsi_bearer(imsiBearer);
    uint8_t http_code              = 0;
    nlohmann::json j = stats;
    // to_json(j, stats);
    response.headers().add<Pistache::Http::Header::ContentType>(
...
void NorthBound4GApiImpl::get_stats_by_id(const std::string &id, Pistache::Http::ResponseWriter &response) {
